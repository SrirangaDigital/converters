...
<?php
	...
	require "menu.php";
	require "anu2Unicode/converter.php";
...
<?php
    ...
    if(isset($_POST['inputtext'])){
        ...
        $anu2unicode = new converter();
        $outputText = $anu2unicode->anu2Unicode($inputShreelipiText);
    }
...
?>
    ...
    <div class="container footer">
        <div class="row converter-box">
            <div class="col-md-12">
                <h1>Anu to Unicode converter (Telugu)</h1>
            </div>
            <div class="col-md-12">
                <form action="anu2unicode.php" method="POST">
                    <div class="form-group">
                        <label for="inputtext">Input Text (Anu2Unicode)</label>
                    ...
                    <div class="text-center"> 
                        <button type="submit" class="btn btn-primary">Convert Anu to Unicode (Telugu)</button>&nbsp;
