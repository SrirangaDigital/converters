...
<?php
	...
	require "menu.php";
	require "shreeSan2Unicode/converter.php";
...
<?php
    ...
    if(isset($_POST['inputtext'])){
        ...
        $outputText = $converter->shreeSan2Unicode($inputNudiText);
    }
...
?>
    ...
    <div class="container footer">
        <div class="row converter-box">
            <div class="col-md-12">
                <h1>Shreelipi (Sanskrit) to Unicode converter</h1>
            </div>
            <div class="col-md-12">
                <form action="shreeSan2Unicode.php" method="POST">
                    <div class="form-group">
                        <label for="inputtext">Input Text in Shreelipi (Sanskrit)</label>
                    ...
                    <div class="text-center"> 
                        <button type="submit" class="btn btn-primary">Convert Shreelipi (Sanskrit) to Unicode</button>&nbsp;
