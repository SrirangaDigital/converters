...
<?php
    ...
    if(isset($_POST['inputtext'])){
        ...
        $akruti2unicode = new Akrutitounicode();
        $outputText = $akruti2unicode->akruti2Unicode($inputNudiText);
    }
...
?>
    ...
    <div class="container footer">
        <div class="row converter-box">
            <div class="col-md-12">
                <h1>Akruti KND Padmini to Unicode converter</h1>
            </div>
            <div class="col-md-12">
                <form action="akruti2Unicode.php" method="POST">
                    ...
                    <div class="text-center"> 
                        <button type="submit" class="btn btn-primary">Convert Akruti KND Padmini to Unicode</button>&nbsp;
