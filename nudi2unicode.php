...
<?php
	...
	require "menu.php";
	require "Nudi2Unicode/nuditounicode.php";
...
<?php
    ...
    if(isset($_POST['inputtext'])){
        ...
        $nudi2unicode = new Nuditounicode();
        $outputText = $nudi2unicode->nudi2Unicode($inputNudiText);
    }
...
?>
    ...
    <div class="container footer">
        <div class="row converter-box">
            <div class="col-md-12">
                <h1>Nudi/Baraha to Unicode converter</h1>
            </div>
            <div class="col-md-12">
                <form action="nudi2unicode.php" method="POST">
                    ...
                    <div class="text-center"> 
                        <button type="submit" class="btn btn-primary">Convert Nudi/Baraha to Unicode</button>&nbsp;
