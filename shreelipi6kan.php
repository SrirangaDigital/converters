...
<?php
	...
	require "menu.php";
	require "shreelipi62Unicode/converter.php";
...
<?php
    ...
    if(isset($_POST['inputtext'])){
        ...
        $outputText = $shreelipikannada->shreelipi6ToUnicode($inputShreelipiText);
    }
...
?>
    ...
    <div class="container footer">
        <div class="row converter-box">
            <div class="col-md-12">
                <h1>Shreelipi6 to Unicode converter (Kannada)</h1>
            </div>
            <div class="col-md-12">
                <form action="shreelipi6kan.php" method="POST">
                    ...
                    <div class="text-center"> 
                        <button type="submit" class="btn btn-primary">shreelipi6kan</button>&nbsp;
